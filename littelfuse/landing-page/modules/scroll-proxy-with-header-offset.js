...
(function (global, factory) {
  ...
  var handleScrollTo = function (sourceWindow, data) {
    ...
    if (frame) {
      // Calculate the position within the iframe after the scroll
      ...
      // Offset the scroll position by the height of the sticky header
      var stickyHeaderHeight =
        document.querySelector(".sticky-header").offsetHeight;
      var scrollToPosition = Math.min(
        frameScrollPosition + frameTop - stickyHeaderHeight,
        maxScroll
      );
