      ...
      CerosSDK.findExperience()
        .done(function (experience) {
          ...
          function handleMasks(node) {
            const masksCollection = experience.findLayersByTag(`mask:${node.children[0].name}`);
          ...
          function handleNewNode(val, name, parent) {
